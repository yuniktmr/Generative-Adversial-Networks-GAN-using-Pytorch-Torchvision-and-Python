# -*- coding: utf-8 -*-
"""
Created on Wed May 29 14:32:40 2019
...
class D(nn.Module):
    ...
    def forward(self, input):
        output = self.main(input)
        return output.view(-1) #array flattening
...
optimizerD = optim.Adam(netD.parameters(), lr = 0.0002, betas = (0.5, 0.999)) #adam = optimizer for stochastic grad descent
optimizerG = optim.Adam(netG.parameters(), lr = 0.0002, betas = (0.5, 0.999))

#the training loop with 25 epochs
